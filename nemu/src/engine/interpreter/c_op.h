...
#ifdef ISA64
#define c_shift_mask 0x3f           //0011 1111=63
#else
#define c_shift_mask 0x1f           //0001 1111=31
#endif

#define c_add(a, b) ((a) + (b))                       //arithmetic operation(add,sub)
#define c_sub(a, b) ((a) - (b))
#define c_and(a, b) ((a) & (b))                       //logical operation(and,or,xor)
#define c_or(a, b)  ((a) | (b))
#define c_xor(a, b) ((a) ^ (b))
#define c_shl(a, b) ((a) << ((b) & c_shift_mask))     //shift left
#define c_shr(a, b) ((a) >> ((b) & c_shift_mask))     //shift right
...
#define c_mul_lo(a, b) ((a) * (b))                    //multiply
...
#else
#define c_mul_hi(a, b) (((uint64_t)(a) * (uint64_t)(b)) >> 32)                     //_hi means 64bit,  _lo means 32bit
#define c_imul_hi(a, b) (((int64_t)(sword_t)(a) * (int64_t)(sword_t)(b)) >> 32)    //imul means signed, mul means unsigned
#endif


#define c_div_q(a, b) ((a) / (b))                     //divide
