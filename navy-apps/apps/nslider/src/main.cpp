...
void render() {
  ...
  slide = SDL_LoadBMP(fname); //slide point to this bmp,   SDL_Surface *SDL_LoadBMP(const char* file)   ,  #include<SDL_bmp.h>
  assert(slide);
...
int main() {
  ...
  //the screen is set below,and the NDL and SDL cant set the screen,can only get them
  //so here W H is canvas_W,canvas_H
