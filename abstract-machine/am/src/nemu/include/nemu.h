...
// before exec the assembly code ,firsly put code in the eax register;
// then the cpu.eax will be the parameter of the rtl_exit: halt_pc, based on this returned value,we get the reason of program ended.
